...
//		}
	...
	// 신청 삭제 요청 처리할 서비스 메서드
	public AttendanceJoinResponseData deleteAttendance(String userId, String moimId) {
		
		AttendanceJoinResponseData ajrd = new AttendanceJoinResponseData();
		Attendance one = attendanceRepository.findByMoimIdAndUserId(moimId, userId);
		attendanceRepository.delete(one);
	...
	// 특정유저가 특정모임에 참여여부 확인하고자 할때 시용할 서비스 메서드
